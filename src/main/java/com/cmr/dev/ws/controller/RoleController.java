...
import com.cmr.dev.business.dto.*;
...
import com.cmr.dev.ws.utils.Spb3UrlBase;
 ...
 */
@RestController
@CrossOrigin(origins = Spb3UrlBase.url, maxAge = Spb3UrlBase.maxAge)
...
public class RoleController {
	 ...
	 */
	@GetMapping("/{id}")
	public ResponseEntity<RoleBasicDTO> getOne(@PathVariable int id) throws Spb3BusinessException {
	 ...
	 */
	@PostMapping
	public ResponseEntity<RoleFullDTO> create(@RequestBody RoleFullDTO dto) throws Spb3BusinessException {
	...
	public ResponseEntity<RoleFullDTO> update(@PathVariable int id, @RequestBody RoleFullDTO dto)
			throws AccessDeniedException, Spb3BusinessException {
	 ...
	 */
	@DeleteMapping("/{id}")
	public ResponseEntity<?> delete(@PathVariable int id) throws Spb3BusinessException, AccessDeniedException {
